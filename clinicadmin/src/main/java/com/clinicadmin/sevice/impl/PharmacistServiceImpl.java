 ...
 // ---------------- UPDATE ----------------
    ...
    public Response updatePharmacist(String pharmacistId, PharmacistDTO dto) {
        ...
        return pharmacistRepository.findByPharmacistId(pharmacistId).map(existing -> {
            ...
            if (dto.getHospitalId() != null) existing.setHospitalId(dto.getHospitalId());
            ...
            if (dto.getPharmacyLicense() != null) existing.setPharmacyLicense(dto.getPharmacyLicense());
            if (dto.getDPharmaOrBPharmaCertificate() != null) existing.setDPharmaOrBPharmaCertificate(dto.getDPharmaOrBPharmaCertificate());
            if (dto.getStatePharmacyCouncilRegistration() != null) existing.setStatePharmacyCouncilRegistration(dto.getStatePharmacyCouncilRegistration());
            ...
            if (dto.getExperienceCertificates() != null) existing.setExperienceCertificates(dto.getExperienceCertificates());
